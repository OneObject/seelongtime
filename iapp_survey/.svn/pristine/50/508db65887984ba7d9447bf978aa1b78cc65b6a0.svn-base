...
@Controller("syncFromWxCpController")
@RequestMapping("/mgr/wx/cp")
public class SyncFromWxCpController {
	
	private static Logger logger = LoggerFactory.getLogger(SyncFromWxCpController.class);
	...
	@RequestMapping("syncfromcp")
	@ResponseBody
	public String syncFromWxCp(HttpServletRequest request){
