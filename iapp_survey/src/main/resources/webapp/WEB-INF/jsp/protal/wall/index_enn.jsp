...
<style type="text/css">
        	*{padding:0px;margin:0px;}
			...
			.head .headR ul li label{color:#fff;font-weight:bold;font-size:24px;}
        	...
        	.msgBox .msg{width:750px;margin:10px 25px 10px 5px;font-size:42px;color:#fff;line-height: 58px;word-break:break-all;overflow: hidden;}
	...
	<div class="head">
 				<div class="headL">
					<c:if test="${empty param.img}">
						<img src="${basepath}/static/wall/img/h1_new.png"  />
					</c:if>
					<c:if test="${not empty param.img}">
						<img src="${basepath}/static/wall/img/${param.img}.png"  />
					</c:if>
 				</div>
 				<div class="headC">
