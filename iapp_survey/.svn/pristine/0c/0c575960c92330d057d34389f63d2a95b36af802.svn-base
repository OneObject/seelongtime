...
<script type="text/javascript">
   $(document).ready(function(){
	   ...
	   if(isok){
		   //easyDialog.close();
		   window.location.href=basepath+"/mgr/signin/count.xhtml?id=${activityId}&from=${from}";
		   }
         ...
         <div class="row">
            <div class="col-md-12">
               ...
               <ul class="page-breadcrumb breadcrumb">
                  ...
                  <li><a href="${basepath }/mgr/signin/count.xhtml?id=${activityId}">签到管理</a>
                  <i class="icon-angle-right"></i></li>
                  <li><span href="Javascript:void(0);">人员导入</span></li>
               </ul>
         ...
         <!-- END PAGE HEADER-->
          <div class="row">
          	<div class="col-md-12" style="display: block;overflow: hidden;margin-bottom: 20px;">
          			<span class="btn btn-success table_add " style="float: left;" onclick="javascript:location.href='${basepath}/modelfile/签到人员导入模板.xls'" >
          ...
          <div class="row">
          <form id="importForm" action="${basepath }/mgr/signin/batchuser.xhtml" enctype="multipart/form-data" method="post">
         	...
         	<div class="col-md-12">
               ...
               <div class="portlet box blue">
                  <div class="portlet-title">
                     <div class="caption"><i class="icon-film"></i>上传人员excel</div>
                  </div>
