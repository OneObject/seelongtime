		...
		<div class="col-lg-12">
			<div class="portlet box green">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-bar-chart-o"></i><span>修改调研活动</span> 
					</div>
				</div>
				<div class="portlet-body main_bd box">
					...
					<div class="col-md-12">
						<!-- 创建 start-->
						<div class="form">
							<form role="form" id="voteActivityForm" action="${basepath }/mgr/voteactivity/updatesave.xhtml" method="post">
								<input type="hidden" name="id" value="${entity.id }"/>
								<div class="form-body">
									<div class="form-group"  id="con_title">
										<label for="biaoti">标题<span class="required">*</span></label>
										<input type="text" class="form-control" value="${entity.title }" name="title" id="title" placeholder="调研活动标题" onchange="v_title();">
									...
									<div class="appmsg_edit_item" style="margin-bottom:10px;">
										...
										<div class="frm_input_box" style="border:1px solid #e5e5e5; padding-top:3px; padding-bottom:-5px;padding-left:10px;">
											...
											<div style="${not empty entity.coverPath ? '' : 'display:none;'}margin-bottom:20px;" id="small_prev">
												<span id="image_cover">
													<c:if test="${not empty entity.coverPath }">
														<img style="max-width:100px;max-height:200px;" src="<%=Constants.IMG_SERVER_DOWNLOAD%>/${entity.coverPath }-360x200">
													</c:if>
												</span>
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" id="voteStartTime" value="${ltfun:dateLongToStringFormat(entity.startTime,'yyyy-MM-dd HH:mm') }" name="startTimeStr" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm', maxDate:'#F{$dp.$D(\'voteEndTime\')}'})">
									</div>
									<div class="form-group">
										<label for="biaoti">结束时间</label>
										<input type="text" class="form-control" id="voteEndTime" value="${ltfun:dateLongToStringFormat(entity.endTime,'yyyy-MM-dd HH:mm') }" name="endTimeStr" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm', minDate:'#F{$dp.$D(\'voteStartTime\')}'})">
									</div>
									
									<div class="form-group">
										<label for="biaoti">发起人/单位</label>
										<input type="text" class="form-control" id="voteAuthor" value="${entity.author }" name="author" placeholder="发起者">
									</div>
									<div class="form-group" id="con_voteSummary">
										<label>简介</label>
										<textarea rows="10" class="form-control" id="voteSummary" name="summary" placeholder="简介">${entity.summary }</textarea>
										<div class="col-md-3">
									...
									<div class="form-group" id="con_voteId">
										<div class="form-group">
											...
											<div class="input-group" onclick="chooseVote();">
			                                    <input name="voteName" id="voteName" readonly="readonly" type="text" class="form-control" value="${entity.voteName }" placeholder="请选择">
			                                    <input name="voteId" id="voteId" type="hidden" value="${entity.voteId }" >
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" id="voteLabels" name="labels" placeholder="标签" value="${entity.labels }">
									</div>
									
									<div style="margin-top:15px;margin-bottom:10px;">
										<input id="isOpen" type="checkbox" name="isOpen" value="1" ${entity.isOpen == 1 ? 'checked="checked"' : '' }>
										<label for="isOpen">公开</label>
										&nbsp;&nbsp;
										<input id="isNotify" type="checkbox" name="isNotify" value="1" ${entity.isNotify == 1 ? 'checked="checked"' : '' }>
										<label for="isNotify">通知参与人员</label>
										&nbsp;&nbsp;
										<input id="showresult" type="checkbox" name="showresult" value="1" ${entity.showresult == 1 ? 'checked="checked"' : '' }>
										<label for="showresult">展示结果</label>
										&nbsp;&nbsp;
										<input id="allowAnonymous" type="checkbox"  name="allowAnonymous" value="1" ${entity.allowAnonymous == 1 ? 'checked="checked"' : '' }>
										<label for="allowAnonymous">允许匿名</label>
										&nbsp;&nbsp;
										<input id="allowUnLogin" type="checkbox"  name="allowUnLogin" value="1" ${entity.allowUnLogin == 1 ? 'checked="checked"' : '' }>
