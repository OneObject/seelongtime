...
(function() {
	...
	function Ca(a, b) {
		...
		e, f, g, h, i, j = []; (c = a.indexOf(c)) !== -1;) {
			...
			if (d) {
				...
				h = M.lang,
				i = void 0,
				/f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e = Aa(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep: "")) : e = Xa(f, e)
			}
			j.push(e);
			a = a.slice(c + 1);
			c = (d = !d) ? "}": "{"
	...
	function Eb(a, b, c, d) {
		...
		if (u(b)) {
			...
			b = 1;
			h = i[ab]();
			for (var d = i.getTime(), l = i[$a](), m = i[Sa](), p = g ? 0 : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c;) e.push(d),
			j === D[Da] ? d = bb(h + b * k, 0) : j === D[Ra] ? d = bb(h, l + b * k) : !g && (j === D[ua] || j === D[Za]) ? d = bb(h, l, m + b * k * (j === D[ua] ? 1 : 7)) : d += j * k,
			b++;
			e.push(d);
			n(ub(e,
			function(a) {
	...
	Ab = {
		...
		O.HighchartsAdapter = O.HighchartsAdapter || a && {
			init: function(b) {
				...
				function(a, b) {
					...
					b === "cur" ? e = c.prototype: b === "_default" && f && (e = g[b], b = "set"); (k = e[b]) && (e[b] = function(c) {
						c = a ? c: this;
						if (c.prop !== "align") return l = c.elem,
			...
			fireEvent: function(b, c, d, e) {
				var f = a.Event(c),
				g = "detached" + c,
				h; ! ta && d && (delete d.layerX, delete d.layerY);
				r(f, d);
	...
	wa.prototype = {
			...
			c !== "d" && c !== "visibility" && c !== "fill" && (q = parseFloat(q));
				...
				for (c in a) if (j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1) {
					...
					if (c === "stroke-width" || c === "stroke") {
						this[c] = d;
						if (this.stroke && this["stroke-width"]) v(g, "stroke", this.stroke),
		...
		on: function(a, b) {
			...
			d.onclick = function(a) { (oa.indexOf("Android") === -1 || Date.now() - (c.touchEventFired || 0) > 1100) && b.call(d, a)
			}) : d["on" + a] = b;
			return this
		},
			...
			if (this.added) {
				...
				if (b.tagName === "SPAN") {
					...
					if (Sb !== this.cTT) {
						...
						A += q * m * (ba ? 1 - h: h);
						L -= p * m * (j ? ba ? h: 1 - h: 1);
						i && (A -= k * h * (p < 0 ? -1 : 1), j && (L -= l * h * (q < 0 ? -1 : 1)), K(b, {
							textAlign: g
						}));
						this.xCorr = A;
						this.yCorr = L
		...
		updateTransform: function() {
			...
			a = ["translate(" + a + "," + b + ")"];
			e ? a.push("rotate(90) scale(-1,1)") : f && a.push("rotate(" + f + " " + (this.x || 0) + " " + (this.y || 0) + ")"); (u(c) || u(d)) && a.push("scale(" + o(c, 1) + " " + o(d, 1) + ")");
		...
		add: function(a) {
			...
			if (g) c.handleZ = !0,
			g = C(g);
			if (c.handleZ) for (c = 0; c < e.length; c++) if (a = e[c], b = v(a, "zIndex"), a !== f && (C(b) > g || !u(g) && u(b))) {
				d.insertBefore(f, a);
				h = !0;
				break
			}
		...
		shadow: function(a, b, c) {
			...
			if (a) {
				...
				for (e = 1; e <= i; e++) {
					...
					if (c) v(f, "height", s(v(f, "height") - h, 0)),
					f.cutHeight = h;
	...
	Ha.prototype = {
		...
		buildText: function(a) {
			...
			c = this,
			d = c.forExport,
			e = o(a.textStr, "").toString().replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g), f = b.childNodes, g = /style="([^"]+)"/, h = /href="(http[^"]+)"/, i = v(b, "x"), j = a.styles, k = j && j.width && C(j.width), l = j && j.lineHeight, m = f.length; m--;) b.removeChild(f[m]);
			...
			function(e, f) {
				...
				function(e) {
					if (e !== "" || m.length === 1) {
						...
						h.test(e) && !d && (v(n, "onclick", 'location.href="' + e.match(h)[1] + '"'), K(n, {
							cursor: "pointer"
						}));
						e = (e.replace(/<(.|\n)*?>/g, "") || " ").replace(/&lt;/g, "<").replace(/&gt;/g, ">");
						if (e !== " " && (n.appendChild(y.createTextNode(e)), o ? p.dx = 0 : p.x = i, v(n, p), !o && f && (!Z && d && K(n, {
							display: "block"
						}), v(n, "dy", l || c.fontMetrics(/px$/.test(n.style.fontSize) ? n.style.fontSize: j.fontSize).h, gb && n.offsetHeight)), b.appendChild(n), o++, k)) for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), u, t, p = a._clipHeight, E = [], w = C(l || 16), B = 1; e.length || E.length;) delete a.bBox,
						u = a.getBBox(),
						t = u.width,
						u = t > k,
						!u || e.length === 1 ? (e = E, E = [], e.length && (B++, p && B * w > p ? (e = ["..."], a.attr("title", a.textStr)) : (n = y.createElementNS(za, "tspan"), v(n, {
							dy: w,
							x: i
						}), s && v(n, "style", s), b.appendChild(n), t > k && (k = t)))) : (n.removeChild(n.firstChild), E.unshift(e.pop())),
		...
		button: function(a, b, c, d, e, f, g, h) {
			...
			n = h.style;
			delete h.style;
			J(i.element, ta ? "mouseover": "mouseenter",
			function() {
				j !== 3 && i.attr(f).css(p)
			});
			J(i.element, ta ? "mouseout": "mouseleave",
			function() {
		...
		label: function(a, b, c, d, e, f, g, h, i) {
			...
			function k() {
				...
				if (u(Oa) && (a === "center" || a === "right")) b += {
					center: 0.5,
					right: 1
				} [a] * (Oa - L.width); (b !== o.x || c !== o.y) && o.attr({
					x: b,
					y: c
				});
				o.x = b;
	...
	if (!Z && !$) {
		Highcharts.VMLElement = F = {
			init: function(a, b) {
				...
				d = ["position: ", "absolute", ";"],
				e = b === Ea; (b === "shape" || e) && d.push("left:0;top:0;width:1px;height:1px;");
			...
			pathToVML: function(a) {
				for (var b = a.length,
				c = [], d; b--;) if (sa(a[b])) c[b] = t(a[b] * 10) - 5;
				else if (a[b] === "Z") c[b] = "x";
			...
			attr: function(a, b) {
				...
				q = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight: this[c];
				else for (c in a) if (d = a[c], m = !1, e = p[c] && p[c].call(this, d, c), e !== !1 && d !== null) {
					e !== w && (d = e);
					...
					m = !0;
					else if (qa(c, ["x", "y", "width", "height"]) !== -1) this[c] = d,
					c === "x" || c === "y" ? c = {
						x: "left",
						y: "top"
					} [c] : d = s(0, d),
		...
		var ma = {
			...
			symbols: {
				...
				rect: function(a, b, c, d, e) {
					var f = a + c,
					g = b + d,
					h; ! u(e) || !e.r ? f = Ha.prototype.symbols.square.apply(0, arguments) : (h = I(e.r, c, d), f = ["M", a + h, b, "L", f - h, b, "wa", f - 2 * h, b, f, b + 2 * h, f - h, b, f, b + h, "L", f, g - h, "wa", f - 2 * h, g - 2 * h, f, g, f, g - h, f - h, g, "L", a + h, g, "wa", a, g - 2 * h, a + 2 * h, g, a + h, g, a, g - h, "L", a, b + h, "wa", a, b, a + 2 * h, b + 2 * h, a, b + h, a + h, b, "x", "e"]);
					return f
				}
			}
		};
	...
	Ma.prototype = {
		addLabel: function() {
			...
			g = d && {
				width: s(1, t(d - 2 * (h.padding || 10))) + "px"
			};
			g = r(g, h.style);
			if (u(e)) e && e.attr({
				text: b
		...
		getLabelPosition: function(a, b, c, d, e, f, g, h) {
			...
			p && i.side === 2 && (b -= m - m * V(p * Ua)); ! u(e.y) && !p && (b += m - c.getBBox().height / 2);
		...
		render: function(a, b, c) {
			...
			if (i && !isNaN(H)) i.xy = E = this.getLabelPosition(H, E, i, g, k, x, a, r),
	...
	vb.prototype = {
		render: function() {
			...
			if (h) {
				...
				if (j = s(j, b.min - d), i = I(i, b.max + d), q = b.getPlotBandPath(j, i, e), d = {
					fill: A
				},
			...
			else if (q && q.length && (a.svgElem = p = w.path(q).attr(d).add(), t)) for (n in e = function(b) {
				p.on(b,
				function(c) {
					t[b].apply(a, [c])
				})
	...
	db.prototype = {
		...
		defaultLabelFormatter: function() {
			...
			else if (f && a >= 1E3) for (; f--&&g === w;) c = Math.pow(1E3, f + 1),
		...
		getSeriesExtremes: function() {
			...
			function(c) {
				if (c.visible || !b.options.chart.ignoreHiddenSeries) {
					...
					a.isLog && d <= 0 && (d = null);
					if (a.isXAxis) {
						if (d = c.xData, d.length) a.dataMin = I(o(a.dataMin, d[0]), Ja(d)),
						a.dataMax = s(o(a.dataMax, d[0]), va(d))
					} else {
						c.getExtremes();
						e = c.dataMax;
						c = c.dataMin;
						if (u(c) && u(e)) a.dataMin = I(o(a.dataMin, c), c),
						a.dataMax = s(o(a.dataMax, e), e);
						if (u(d)) if (a.dataMin >= d) a.dataMin = d,
		...
		adjustForMinRange: function() {
			...
			f, g, h, i, j;
			if (this.isXAxis && this.minRange === w && !this.isLog) u(a.min) || u(a.max) ? this.minRange = null: (n(this.series,
			function(a) {
				i = a.xData;
		...
		setAxisTranslation: function(a) {
			...
			function(a) {
				...
				c = s(c, g);
				e = s(e, ea(h) ? 0 : g / 2);
				f = s(f, h === "on" ? 0 : g); ! a.noSharedTooltip && u(l) && (d = u(d) ? I(d, l) : l)
			}),
		...
		setTickPositions: function(a) {
			...
			if (e) ! a && I(b.min, o(b.dataMin, b.min)) <= 0 && ka(10, 1),
			b.min = ia(na(b.min)),
			b.max = ia(na(b.max));
			...
			if (!a) ! b.ordinalPositions && (b.max - b.min) / b.tickInterval > s(2 * b.len, 200) && ka(19, !0),
		...
		getOffset: function() {
			...
			if (j || a.isLinked) {
				...
				if (a.staggerLines) ba *= a.staggerLines,
				a.labelOffset = ba
		...
		render: function() {
			...
			q = a.tickmarkOffset,
			o = d.lineWidth,
			A, s = b.hasRendered && u(a.oldMin) && !isNaN(a.oldMin);
			A = a.hasData;
			var t = a.showAxis,
			r, v;
			n([j, k, l],
			...
			if (A || f) if (a.minorTickInterval && !a.categories && n(a.getMinorTickPositions(),
			function(b) {
			...
			function(b, c) {
				...
				if (!f || b >= a.min && b <= a.max) j[b] || (j[b] = new Ma(a, b)),
				s && j[b].isNew && j[b].render(c, !0),
				j[b].render(c, !1, 1)
			}), q && a.min === 0 && (j[ - 1] || (j[ - 1] = new Ma(a, -1, null, !0)), j[ - 1].render( - 1))), p && n(g,
			function(b, c) {
				if (c % 2 === 0 && b < a.max) l[b] || (l[b] = new vb(a)),
				r = b + q,
			...
			if (o) A = a.getLinePath(o),
			a.axisLine ? a.axisLine.animate({
				d: A
			}) : a.axisLine = c.path(A).attr({
				stroke: d.lineColor,
				"stroke-width": o,
				zIndex: 7
			}).add(a.axisGroup),
	...
	wb.prototype = {
		...
		move: function(a, b, c, d) {
			...
			e.label.attr(f);
			if (g && (N(a - f.x) > 1 || N(b - f.y) > 1)) clearTimeout(this.tooltipTimeout),
		...
		refresh: function(a, b) {
			...
			if (l) {
				l = ja(l);
				for (d = l.length; d--;) if (m = a.series, e = m[d ? "yAxis": "xAxis"], l[d] && e) if (h = d ? o(a.stackY, a.y) : a.x, e.isLog && (h = na(h)), d === 1 && m.modifyValue && (h = m.modifyValue(h)), e = e.getPlotLinePath(h, 1), this.crosshairs[d]) this.crosshairs[d].attr({
					d: e,
					visibility: "visible"
				});
				else {
	...
	xb.prototype = {
		...
		runPointActions: function(a) {
			...
			if (d && this.options.tooltip.shared && (!g || !g.noSharedTooltip)) {
				e = [];
				h = c.length;
				for (i = 0; i < h; i++) if (c[i].visible && c[i].options.enableMouseTracking !== !1 && !c[i].noSharedTooltip && c[i].tooltipPoints.length && (b = c[i].tooltipPoints[k]) && b.series) b._dist = N(k - b.clientX),
				j = I(j, b._dist),
				e.push(b);
		...
		reset: function(a) {
			...
			d = b.hoverPoint,
			e = b.tooltip,
			b = e && e.shared ? b.hoverPoints: d; (a = a && e && b) && ja(b)[0].plotX === w && (a = !1);
			if (a) e.refresh(b);
			else {
				if (d) d.onMouseOut();
				if (c) c.onMouseOut();
		...
		pinchTranslateDirection: function(a, b, c, d, e, f, g) {
			...
			v = !t && c[1][k],
			x,
			c = function() { ! t && N(u - w) > 20 && (o = N(r - v) / N(u - w));
				q = (m - r) / o + u;
		...
		pinch: function(a) {
			...
			function(a) {
				...
				b.hasPinched = k;
				b.scaleGroups(m, q); ! k && e && g === 1 && this.runPointActions(b.normalize(a))
			}
		},
		...
		inClass: function(a, b) {
			for (var c; a;) {
				if (c = v(a, "class")) if (c.indexOf(b) !== -1) return ! 0;
		...
		onContainerClick: function(a) {
			...
			}), z(c.series, "click", r(a, {
				point: c
			})), b.hoverPoint && c.firePointEvent("click", a)) : (r(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && z(b, "click", a))
		},
	...
	eb.prototype = {
		init: function(a, b) {
			...
			f = b.itemMarginTop || 0;
			this.options = b;
			if (b.enabled) c.baseline = C(d.fontSize) + 3 + f,
			c.itemStyle = d,
		...
		renderItem: function(a) {
			...
			if (!t && (a.legendGroup = d.g("legend-item").attr({
				zIndex: 1
			}).add(b.scrollGroup), u.drawLegendSymbol(b, a), a.legendItem = t = d.text(e.labelFormat ? Ca(e.labelFormat, a) : e.labelFormatter.call(a), m ? g + h: -h, b.baseline, v).css(x(a.visible ? i: j)).attr({
				align: m ? "left": "right",
				zIndex: 2
			}).add(a.legendGroup), (v ? t: a.legendGroup).on("mouseover",
			function() {
				a.setState("hover");
			...
			if (f && b.itemX - A + e > (p || c.chartWidth - 2 * k - A)) b.itemX = A,
	...
	/Trident.*?11\.0/.test(oa) && mb(eb.prototype, "positionItem",
	function(a, b) {
		var c = this;
		setTimeout(function() {
			a.call(c, b)
	...
	yb.prototype = {
		...
		initSeries: function(a) {
			var b = this.options.chart; (b = W[a.type || b.type || b.defaultSeriesType]) || ka(17, !0);
			b = new b;
			b.init(this, a);
			return b
		},
		...
		layOutTitles: function() {
			...
			d), !1, "spacingBox"), !d.floating && !d.verticalAlign && (a = xa(a + c.getBBox().height)));
			this.titleOffset = a
		},
		...
		cloneRenderTo: function(a) {
			...
			c = this.container;
			a ? b && (this.renderTo.appendChild(c), Ta(b), delete this.renderToClone) : (c && c.parentNode === this.renderTo && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), K(b, {
				position: "absolute",
				top: "-9999px",
				display: "block"
		...
		getContainer: function() {
			...
			a || ka(13, !0);
			c = C(v(a, "data-highcharts-chart")); ! isNaN(c) && Ga[c] && Ga[c].destroy();
		...
		drawChartBox: function() {
			...
			if (k) f ? f.animate(t) : this.plotBackground = b.rect(q, o, n, s, 0).attr({
				fill: k
	...
	Pa.prototype = {
		...
		destroy: function() {
			...
			if (this.graphic || this.dataLabel) aa(this),
		...
		onMouseOut: function() {
			var a = this.series.chart,
			b = a.hoverPoints;
			if (!b || qa(this, b) === -1) this.firePointEvent("mouseOut"),
			this.setState(),
			a.hoverPoint = null
		},
	...
	Q.prototype = {
		...
		bindAxes: function() {
			...
			function(e) {
				...
				function(c) {
					d = c.options;
					if (b[e] === d.index || b[e] !== w && b[e] === d.id || b[e] === w && d.index === 0) c.series.push(a),
					a[e] = c,
					c.isDirty = !0
				});
				a[e] || ka(18, !0)
		...
		getColor: function() {
			...
			if (!e && !a.colorByPoint) u(b._colorIndex) ? a = b._colorIndex: (b._colorIndex = d.color, a = d.color++),
			e = c[a];
			this.color = e;
		...
		getSymbol: function() {
			...
			if (!this.symbol) u(a._symbolIndex) ? a = a._symbolIndex: (a._symbolIndex = c.symbol, a = c.symbol++),
			this.symbol = d[a];
		...
		setData: function(a, b) {
			...
			if (i && m > i) {
				...
				if (sa(f)) {
					...
					f += d;
					this.xIncrement = f
				} else if (Ia(f)) if (p) for (i = 0; i < m; i++) d = a[i],
				j[i] = d[0],
				k[i] = d.slice(1, p + 1);
		...
		generatePoints: function() {
			...
			b = this.data = b;
			for (m = 0; m < g; m++) i = h + m,
			j ? l[m] = (new f).init(this, [d[m]].concat(ja(e[m]))) : (b[i] ? k = b[i] : a[i] !== w && (b[i] = k = (new f).init(this, a[i], d[m])), l[m] = k);
		...
		setPercentStacks: function() {
			...
			function(b) {
				var d;
				for (var e = a.xData.length,
				f, g; e--;) if (f = a.xData[e], d = (g = c[b] && c[b][f]) && g.points[a.index], f = d) g = g.total ? 100 / g.total: 0,
				f[0] = ia(f[0] * g),
				f[1] = ia(f[1] * g),
		...
		getExtremes: function() {
			...
			k,
			l;
			for (l = 0; l < d; l++) if (j = b[l], k = c[l], i = k !== null && k !== w && (!a.isLog || k.length || k > 0), j = this.getExtremesFromAll || this.cropped || (b[l + 1] || j) >= h && (b[l - 1] || j) <= g, i && j) if (i = k.length) for (; i--;) k[i] !== null && (e[f++] = k[i]);
			else e[f++] = k;
		...
		translate: function() {
			...
			h = !!this.modifyValue,
			i = a.pointPlacement,
			j = i === "between" || sa(i), k = a.threshold, a = 0; a < g; a++) {
				var l = f[a],
				m = l.x,
				p = l.y,
				q = l.low,
		...
		drawPoints: function() {
			...
			a = l.enabled && i.enabled === w || i.enabled, m = c.isInsidePlot(t(d), e, c.inverted), a && e !== w && !isNaN(e) && g.y !== null) if (a = g.pointAttr[g.selected ? "select": ""], h = a.r, i = o(i.symbol, this.symbol), j = i.indexOf("url") === 0, k) k.attr({
	...
	F = ha(Q, {
		...
		getColumnMetrics: function() {
			...
			function(b) {
				var c = b.options,
				e = b.yAxis;
				if (b.type === a.type && b.visible && d.len === e.len && d.pos === e.pos) c.stacking ? (f = b.stackKey, g[f] === w && (g[f] = i++), h = g[f]) : c.grouping !== !1 && (h = i++),
				b.columnIndex = h
			});
		...
		drawPoints: function() {
			...
			function(e) {
				var f = e.plotY,
				g = e.graphic;
				if (f !== w && !isNaN(f) && e.y !== null) d = e.shapeArgs,
			...
			if (a.visible && (e.enabled || a._hasPointLabels)) {
				...
				for (H = 2; H--;) {
					...
					for (B = 0; B < J; B++) {
						...
						r.connX = y;
						r.connY = z;
						if (this.options.size === null) w = r.width,
						y - w < f ? D[3] = s(t(w - y + f), D[3]) : y + w > h - f && (D[1] = s(t(y + w - h + f), D[1])),
						z - x / 2 < 0 ? D[0] = s(t( - z + x / 2), D[0]) : z + x / 2 > d && (D[2] = s(t(z + x / 2 - d), D[2]))
					}
				}
				if (va(D) === 0 || this.verifyDataLabelOverflow(D)) this.placeDataLabels(),
				u && g && n(this.points,
				function(b) {
					i = b.connector;
					v = b.labelPos;
					if ((r = b.dataLabel) && r._pos) E = r._attr.visibility,
					y = r.connX,
					z = r.connY,
