...
<html lang="zh-CN">
	...
	<title> 回答${questionEntity.author_name}的问题</title>
...
<body> 
    <article class="wenda wenda1">
    	<section class="txt">
        	<div><textarea id="content" placeholder="输入你的回答..."></textarea></div>
            <span onclick="answer()">提交</span>        	
        </section>        
    </article> 
    ...
    <script type="text/javascript">
		...
		function answer(){
			...
			$.ajax({
	    		type : "POST",
	    		url : "${basepath}/m/h5/ask/answer.json",
	    		data : {  
	    			askid : askid,
	    			content : content
	    		},
	    		success : function(data) {  
	        		if(data == true)
	            	{
	        			window.location.href="${basepath}/m/h5/ask/detail.xhtml?askid="+askid+"&activityid="+activityid;
	            	}
	    		},
	    		error : function() {
	    		}
