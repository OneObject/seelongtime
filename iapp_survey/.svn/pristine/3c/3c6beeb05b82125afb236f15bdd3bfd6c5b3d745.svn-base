...
<!-- BEGIN HEAD -->
<head>
<meta name="menu_path" content="video.videoUploaded"/>
<title>已上传视频列表</title>
              ...
              <div class="col-md-12">
               ...
               <div class="portlet box blue">
                  <div class="portlet-title">
                     <div class="caption"><i class="icon-globe"></i>已上传视频列表</div>
                  </div>
                  <div class="portlet-body" style="overflow: hidden;padding-bottom: 100px;">
                      <div class="row">
                            <span class="btn btn-info table_add"  onclick="doflushVideoStatus();">
                               <i class="glyphicon"></i>刷新视频状态</span>
                      </div>
...
<script type="text/javascript" src="${basepath }/static/public/javascripts/ivideo/alreadyupload.js" charset="UTF-8"></script>    
</content>
