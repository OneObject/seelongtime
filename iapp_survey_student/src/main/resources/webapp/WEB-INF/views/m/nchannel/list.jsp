...
function page(num){
	...
	if (list!=null&&list.length>0){
		...
		html = html+'<ul class="courselist" > <li class="cutpage"><div>';
		
		if(num==1){
			html = html+'<a class="button" href="javascript:void();">上一页</a>';
		}else{
		...
		if(num==totalPage){
			html = html+'<a class="button" href="javascript:void();">下一页</a>';
		}else{
