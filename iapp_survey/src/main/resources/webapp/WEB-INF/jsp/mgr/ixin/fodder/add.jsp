...
<body>
	...
	<div class="row">
		<div class="col-md-12">
			...
			<c:if test="${not empty id}">
			<li><i class="icon-home"></i> <a href="${basepath }/mgr/fodder/groupmessage.xhtml">消息群发</a><i class="icon-angle-right"></i></li>
			<li><span>消息创建</span></li>
			</c:if>
			<c:if test="${empty id }">
			...
			<div class="portlet box green">
				<div class="portlet-title">
					<div class="caption">
						...
						<input type="hidden" id="hid_channelid" name="hid_channelid" value="${channelid}">
						...
						<div class="appmsg  editing">
							<div id="js_appmsg_preview" class="appmsg_content">
								<div id="appmsgItem1" data-fileid="" data-id="1"
									...
									<%-- <p class="appmsg_desc" id="matter_desc"></p> --%>
							...
							<div class="inner">
								<div class="appmsg_edit_item">
									<label for="" class="frm_label">标题</label> <span
										...
										class="frm_input js_title" onkeyup="autoSyncContent(this,'single_title');"  onblur="autoSave(false);"></span>
								</div>
								<div class="appmsg_edit_item">
									<label for="" class="frm_label"> <strong class="title">作者</strong>
										<p class="tips l">（选填）</p>
									</label> <span class="frm_input_box"><input type="text" id="author"
										class="frm_input js_author " onblur="autoSave(false);"></span>
								</div>
								<div class="appmsg_edit_item">
								...
								<div class="js_desc_area dn appmsg_edit_item"
									...
									<label for="" class="frm_label">摘要（120字以内）</label> <span
										class="frm_textarea_box"><textarea id="summary"
											class="js_desc frm_textarea" onblur="" onkeyup=""></textarea></span>
 										<%--	class="js_desc frm_textarea" onblur="" onkeyup="autoSyncContent(this,'matter_desc')"></textarea></span> --%>
								</div>
								<div id="js_ueditor" class="appmsg_edit_item content_edit">
									...
									-->
									<textarea name="后台取值的key" id="myEditor" style="border: #f8f8f8;background-color: #f8f8f8;">
									</textarea>
								</div>
								...
								<div class="appmsg_edit_item">
									<label for="" class="frm_label">跳转链接</label> <span
										...
										class="js_gotourl frm_input" onblur=""></span>
								</div>
								<p>
...
var editor = UE.getEditor('myEditor',{
    ...
    //,imageSuffix:"-480x480"
    ,imageSuffix:"-imageView0h520q85"      // ?imageView/0/h/520/q/85
