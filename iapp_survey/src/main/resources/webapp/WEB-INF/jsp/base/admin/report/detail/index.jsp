...
<!-- BEGIN PAGE HEADER-->
              ...
              <div class="col-md-12">
               ...
               <div class="portlet box blue">
                  <div class="portlet-title">
                     <div class="caption"><i class="icon-globe"></i>报表模块列表</div>
                  </div>
   ...
   <tbody id="tbody">
	          ...
	          <tr>
	             ...
	             <td >课程访问详情</td>
	             <td>
	                  <a href="${basepath }/base/admin/report/appoint/appointindex.xhtml?model=course">
	                      <span>
	                         		进入
	                     </span>
	                  </a>
	          ...
	          <tr>
	             ...
	             <td >调研（投票）访问详情</td>
	             <td>
	                  <a href="${basepath }/base/admin/report/appoint/appointindex.xhtml?model=survey">
	                      <span>
	                         		进入
	                     </span>
	                  </a>
	          ...
	          <tr>
	             ...
	             <td >素材访问详情</td>
	             <td>
	                  <a href="${basepath }/base/admin/report/appoint/appointindex.xhtml?model=fodder">
	                      <span>
	                         	            进入
	                     </span>
	                  </a>
