		...
		<div class="col-md-12">
			...
			<div class="portlet box green">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-bookmark-o"></i><span>考试授权</span>
					</div>
				</div>
				<div class="portlet-body form box_box">
					<div class="col-md-12" id="course_info">
					      <ul class="stemp-box" style="width: 590px;">
			                ...
			                <li class="current-step" onclick="next3('${tid}','${isAddOrUpdate }');">
			                    3
			                </li>
			            ...
			            <div class="preview-style">
			                <div class="portlet-body" style="overflow: hidden;padding-bottom: 30px;">
			                    ...
			                    <div class="row">
				                    <!-- 用户组织选择 -->
				                    <div class="col-md-12">
                						<input type="checkbox"   id="authorize" ${sign eq 1?'checked="checked"':''}>
				                       <label >无需授权</label>
				                       <span  style="display:inline;color:gray;font-size:10px;">(勾选后所有人都将可以参加该考试)</span>
                				    </div>
				                    <div class="col-md-12">
			                      ...
			                      <div class="form-group" style="text-align: right">
								  		...
								  		<input type="hidden" id="isAddOrUpdate" name="isAddOrUpdate" value="${isAddOrUpdate }" />
								  		<input type="hidden" id="domain" name="domain" value="${domain }" />
					                    <span class="btn btn-success" onclick="next2('${tid}')"><i class="glyphicon glyphicon-arrow-left"></i>&nbsp;&nbsp;上一步</span>
					                    <span class="btn btn-success" onclick="doStep3();"><i class="glyphicon glyphicon-floppy-save"></i>&nbsp;&nbsp;下一步</span>
