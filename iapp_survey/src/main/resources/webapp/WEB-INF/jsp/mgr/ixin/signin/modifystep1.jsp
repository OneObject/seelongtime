		...
		<div class="col-lg-12">
			<div class="portlet box yellow">
				<div class="portlet-title">
					<div class="caption">
						<i class="glyphicon glyphicon-plus"></i><span >修改签到</span>
					</div>
				</div>
				<div class="portlet-body main_bd box">
					...
					<div class="row">
						<div class="mauto">
							<div class="col-md-12">
								<div class="edit">
									<div class="form">
											<form role="form" id="form1" action="${basepath }/mgr/signin/modifystep1.xhtml">
												<div class="form-body">
													<div class="form-group" id="con_name">
														<label  class="control-label">签到标题<span class="required">*</span></label>
														<input type="text" class="form-control" data-required="1" id="name" name="name" placeholder="请输入标题" value="${entity.name }">
													...
													<div class="form-group" id="con_remark">
														...
														<input type="text" class="form-control" data-required="1" id="remark" name="remark" placeholder="请输入简介" value="${entity.remark }">
														<span class="help-block">
														</span>
													</div>
													...
													<div class="form-group" id="con_code">
														...
														<input type="text" class="form-control" data-required="1" id="code" name="code" placeholder="请输入签到码" value="${entity.signinCode }">
														<span class="help-block">
														</span>
													</div>
					...
					<div class="row">
						<a  onclick="validateAll()"><span class="btn yellow btn-block"><i class="glyphicon glyphicon-arrow-right"></i>&nbsp;下一步</span></a>
					</div>
					<!--  =====================end========================= -->
				</div>
			</div>
