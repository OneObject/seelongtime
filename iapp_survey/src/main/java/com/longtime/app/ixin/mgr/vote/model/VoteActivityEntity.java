...
@Entity
@Table(name = "ixin_vote_activity")
public class VoteActivityEntity  extends BaseModel<String>{
	...
	public static VoteActivityEntity getVoteEntityByVoteVO(VoteVO vo,String domain){
		try{
	...
	public static VoteVO castToVoteVO(VoteActivityEntity entity){
	...
	public String toString() {
		return String.format(
				"VoteActivityEntity [id=%s, title=%s, coverPath=%s, fileId=%s, summary=%s, author=%s, startTime=%s, endTime=%s, weight=%s, labels=%s, showresult=%s, isrelease=%s, voteNum=%s, rootpaths=%s, voteId=%s, voteName=%s, isOpen=%s, isNotify=%s, allowAnonymous=%s, domain=%s, creator=%s, createTime=%s, creatorName=%s, updater=%s, updatetime=%s, updaterName=%s, del=%s, resultconfig=%s]",
				id, title, coverPath, fileId, summary, author, startTime, endTime, weight, labels, showresult,
				isrelease, voteNum, rootpaths, voteId, voteName, isOpen, isNotify, allowAnonymous, domain, creator,
				createTime, creatorName, updater, updatetime, updaterName, del, resultconfig);
	}
