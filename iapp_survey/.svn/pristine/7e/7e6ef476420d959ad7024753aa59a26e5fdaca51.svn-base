...
<head>
<title>学习管理</title>
	<meta name="menu_path" content="ixin.menu_study"/>
	...
	<div class="row">
		<div class="col-md-12">
			...
			<ul class="page-breadcrumb breadcrumb">
                  ...
                  <li><span href="javascript:void(0)">学习列表</span></li>
               </ul>
              ...
              <div class="col-md-12">
               ...
               <div class="portlet box blue">
                  <div class="portlet-title">
                     <div class="caption"><i class="icon-globe"></i>学习列表</div>
                  </div>
                  <div class="portlet-body" style="overflow: hidden;padding-bottom: 100px;">
                      <div class="row">
                            <span class="btn btn-success table_add"  onclick="insertEntity();">
                               <i class="glyphicon glyphicon-plus"></i>添加学习</span>
                      </div>
...
function insertEntity(){
	location = "${basepath}/mgr/study/add.xhtml";
}
page(1);
function page(i){
	$('#table_list').load("${basepath}/mgr/include/studylist.xhtml?currPage="+i);
}
var submitId = "";
var baseId = "";
var btnFn = function(){
	$.ajax({
		type: "POST",
		url:  basepath+"/mgr/study/del.xhtml",
