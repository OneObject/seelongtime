		...
		<div class="col-lg-12">
			<div class="portlet box green">
				<div class="portlet-title">
					<div class="caption">
						<i class="glyphicon glyphicon-plus"></i><span>活动修改第二步</span>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="col-md-5">
									<div class="preview">
										<div class="title">
											<a href="#">${reward.explain2.title }</a>
										</div>
										<div class="datetime">
											2014.01.02-2014.03.06
										</div>
										<div class="img">
											<img src="http://img0.aijiayou.com/${reward.explain2.picUrl }">
										</div>
										<div class="description">
											${reward.explain2.content } 
										</div>
									</div>
							</div>
							<div class="col-md-6">
								<div class="edit">
									<div class="form">
											<form role="form" id="form2" action="${basepath }/mgr/scratchcard/modifyrewardsecondstep.xhtml">
												<div class="form-body">
													<input type="hidden" name="id" value="${reward.id }">
													<div class="form-group" id="con_title2">
														<label for="title2" class="control-label">开始刮奖标题</label>
														<input type="text" class="form-control" id="title2" name="title2" value="${reward.explain2.title }">
														<span class="help-block">
														</span>
													</div>
													<div class="form-group" id="con_picUrl2">
														<label for="picUrl2" class="control-label">开始抽奖消息封面图片，必须上传一张图片（350*200）</label>
														<div class="upload_box">
															<div class="upload_area">
																<input type="hidden" name="picUrl2" id="picUrl2" value="${reward.explain2.picUrl }" />
															...
															<p class="js_cover upload_preview" >
																<div style="display: " id="small_prev">
																	<span id="image_cover">
																	<img style="max-width:100px;max-height:200px;" src="http://img0.aijiayou.com/${reward.explain2.picUrl }">
													...
													<div class="form-group" id="con_content2">
														<label for="content2" class="control-label">兑奖说明</label>
														<textarea class="form-control" rows="3" id="content2" name="content2">${reward.explain2.content }</textarea>
														<span class="help-block">
														</span>
													</div>
												</div>
