...
<!-- BEGIN HEAD -->
<head>
<meta name="menu_path" content="course.coursePublish"/>
<title>课程发布管理</title>
				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<%-- <div class="input-append date time_box" id="datetimepicker_start"
							...
							<input type="text" value="${nowTime }" name="startTime" id="startTime" value="${nowtime }"> <span
						...
						<div class="col-md-4">
                            <select class="form-control select2me" data-placeholder="选择" name="releaseStatus" id="releaseStatus" onchange="page(1)" >
                                ...
                                <c:forEach items="${statusMap }" var="qt" varStatus="st">
                                    <option value="${qt.key }" id="type_${qt.key }" >${qt.value }</option>
                                </c:forEach>
                            </select>
						</div>
					</div>
...
<script type="text/javascript" src="${basepath }/static/public/javascripts/course/courserelease.js" charset="UTF-8"></script>    
</content>
