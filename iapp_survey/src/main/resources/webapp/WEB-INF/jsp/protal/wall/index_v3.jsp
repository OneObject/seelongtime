...
<section class="wallBox">
	<div class="head">
 				<div class="headL">
 					<img src="${basepath}/static/wall/img/h1.png"  />
 				</div>
 				<div class="headC">
...
jq(function(){
	    ...
	    jq("body,.wallBox").bind("mousedown",function(){
	   	 	clearAuto();
	    });
	    stamp = Date.now();
	    setInterval(function () {
	   		 if (Date.now() - stamp > 10000) {
	   			  setGap(); //需要滚屏时，调用
	   		 }
	    }, 10000);
	    content = jq(".content");
	...
	function setGap(){
 	...
 	function scrollWall(){
 		...
 		if(myScroll.y > myScroll.maxScrollY){
 			myScroll.y = myScroll.y - 1;
 			content.css({"transform":"translate3d(0px, "+myScroll.y+"px, 0px)"});
 		}else{
 			myScroll.y = 0;
 		}
 	} 	
