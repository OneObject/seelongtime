         ...
         <div class="form-group"  >
			<div class="portlet box green">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-bookmark-o"></i><span>资料授权</span>
					</div>
				</div>
				<div class="portlet-body form box_box">
					<div class="col-md-12" id="course_info">
					      <ul class="stemp-box" style="width: 450px;">
							...
							<li class="over-step" onclick="next1('${id}');">1</li>
							<li class="step-xian-lv"></li>
							<li class="current-step" onclick="next2('${id}');">2</li>
							<li class="step-xian${stepStatus['3'] ?'-lv':'' }"></li>
							<li class="${stepStatus['3'] ?'over':'nor' }-step"
								onclick="next3('${id}');">3</li>
			                ...
			                <div class="portlet-body" style="overflow: hidden;padding-bottom: 30px;">
			                    ...
			                    <div class="row">
				                  ...
				                  <div class="form-group" style="height: 50px;">
									...
									<div class="col-sm-9">
										<c:if test="${entity.openstatus eq 1 }">
											<div class="switch">
												<input type="checkbox" checked id="myswitch3" value="1" />
											</div>
										</c:if>

										<c:if test="${entity.openstatus eq 0}">
											<div class="switch">
                				 ...
                				 <div class="form-group" id="practice_group" style="display:${entity.openstatus eq 1?'none':'block' } ">
				                    <div class="col-md-12">
			                      ...
			                      <div class="form-group" style="text-align: right">
					                    ...
					                    <span class="btn btn-success" onclick="savestep2('${id}');"><i class="glyphicon glyphicon-floppy-save"></i>&nbsp;&nbsp;下一步</span>
