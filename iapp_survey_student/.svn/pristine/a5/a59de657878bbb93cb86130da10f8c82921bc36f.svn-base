...
public class FreemarkerUtils {
	...
	public static void main(String[] args) {
		...
		context.put("loginname", "songshaopu");
		context.put("pwd", "123456");
		String str = FreemarkerUtils.toString("findpwd.ftl", context);
		...
		str = FreemarkerUtils.toString2("${loginname}--${name}", context);
		System.out.println(str);
		
		
		str = FreemarkerUtils.toString("findpwd.ftl", context);
        System.out.println(str);
	}
