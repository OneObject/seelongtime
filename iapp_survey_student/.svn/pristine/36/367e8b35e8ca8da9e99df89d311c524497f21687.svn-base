...
<body>
	...
	<div style="display:block;padding: 8px; ">
     <div style="text-align: center;width:200px;margin: 0px auto;clear:both;overflow:hidden;">
        <input type="text" id="name" value="${name}"  style=" width:130px; border:1px solid #ddd;padding: 5px;float: left;">
		<img  src="${basepath}/static/img/frame/find.png" class="search_btn" onclick="dosearch();" style="float: left;margin-left: 10px;height: 30px;" >         		
      </div>
    </div>
