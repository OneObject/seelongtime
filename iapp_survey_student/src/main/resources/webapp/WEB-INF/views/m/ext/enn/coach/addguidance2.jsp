...
<html>
	...
	<body class="bg-color-gray">
        ...
        <section class="wrapper-static margin-top-50">
            <div class="block-edit-box block-edit-box-2">
                ...
                <div class="edit">
                    <div id="text-holder" class="text-holder min-height-48">${task.title }</div>
                </div>
                <div class="edit-title">表现好的方面</div>
                <div  class="edit">
                    <textarea placeholder="" class="min-height-64" id="advantage">${record.gains }</textarea>
                </div>
                <div class="edit-title">待改进的方面</div>
                <div class="edit">
                    <textarea placeholder="" class="min-height-64" id="weakness">${record.problem}</textarea>
                </div>
                <div class="date">
            ...
            <div class="block-date-box">
                ...
                <div class="select-date"><input type="text" id="select-date2" placeholder="请输入日期" /><label></label></div>
            </div>
        </section>
        ...
        <div class="dialog-selector-wrapper" id="dialog-selector-wrapper" style="display: none;">
            <div class="dialog-selector-box-text" id="dialog-selector-box-text">
             ...
             <input type="hidden" id="uids" value="${uid },">
        </div>
        ...
        <script type="text/javascript">
            ...
            $(function () {
                ...
                $('#select-date2').mobiscroll().date(dateOps);
