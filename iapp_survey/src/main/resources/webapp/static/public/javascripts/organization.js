...
function zTreeOnClick(event, treeId, treeNode) {
	...
	var url = basepath+"/base/admin/organization/org_detail.xhtml";
	//alert(url);
...
function onLoadOrg(){
   window.location.href=basepath+"/base/admin/organization/orgloadindex.xhtml";
}
...
function submitSuccessBak(ret){
	if(ret.flag){
		myAutoHideDialog(ret.message, "success", function (){location.href = basepath+"/base/admin/organization/organization.xhtml?id="+ret.id;})
	} else{
...
//        	document.form_delete.submit();
	...
	$.get(basepath+"/base/admin/organization/delete.xhtml", $.param($("#delete_parentId, #delete_id")), submitSuccessBak);
