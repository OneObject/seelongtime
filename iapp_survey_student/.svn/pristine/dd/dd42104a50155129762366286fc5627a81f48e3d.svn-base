...
public class HttpServletHelper {
    ...
    public static Pageable assembyPage(HttpServletRequest request){
        String page = request.getParameter("page");
        String size = request.getParameter("size");
        int pageNumber = NumberUtils.toInt(page, Pageable.FIRST_PAGE_NUMBER);
        int pageSize = NumberUtils.toInt(size,Pageable.DEFAULT_PAGE_SIZE);
