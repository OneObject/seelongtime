...
<body>
	<div class="paper">
		<div class="exam_top">
			...
			<div class="fl"><fmt:message key="fillall.question" bundle="${bundle}"/>${size}<fmt:message key="fillall.ge" bundle="${bundle}"/>，<fmt:message key="fillall.use_time" bundle="${bundle}"/>${size*15/10}&nbsp;<fmt:message key="fillall.minute" bundle="${bundle}"/></div>
			</div>
