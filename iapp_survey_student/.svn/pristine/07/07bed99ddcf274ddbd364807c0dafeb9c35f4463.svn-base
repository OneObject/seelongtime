...
--%>
<script src="${basepath}/static/m/new/js/zepto.js"></script>
<script type="text/javascript" src="${basepath}/static/m/userInfo.js"></script>
<script type="text/javascript">
    ...
    function setUser(){
		...
		function(data){
    		if(data){
   			  window.location.href="${basepath}/m/ixin/lottery/cardreward.xhtml?rewardId=${reward.id}&uid=${uid}";
            }else{
   			  window.location.href="${basepath}/m/ixin/lottery/detail.xhtml?rewardId=${reward.id}&uid=${uid}";
            }
		});
