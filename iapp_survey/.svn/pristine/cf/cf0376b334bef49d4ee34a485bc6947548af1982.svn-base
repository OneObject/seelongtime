...
(function () {
    ...
    //var baseFileSavePath = "http://img.aijiayou.com/";
    //var baseQNServerPath = "http://up.qiniu.com/";
    var baseFileSavePath = imgurl;
    var baseQNServerPath = uploadurl;
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:baseQNServerPath             //图片上传提交地址
        ,imagePath:baseFileSavePath                   //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        //附件上传配置区
        ,fileUrl:baseQNServerPath              //附件上传提交地址
        ,filePath:baseFileSavePath                  //附件修正地址，同imagePath
        ...
        , toolbars:[["source","bold","italic","underline","|","insertorderedlist","insertunorderedlist","|","insertimage","|",'removeformat','forecolor','backcolor','fullscreen'/*,"insertvideo"*/]]
