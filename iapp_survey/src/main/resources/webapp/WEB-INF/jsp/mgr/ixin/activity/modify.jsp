		...
		<div class="col-md-12">
			...
			<div class="portlet box green">
				<div class="portlet-title">
					<div class="caption">
						<i class="icon-reorder"></i><span>更改信息</span>
					</div>
				</div>
				<div class="portlet-body form box_box">
					<div class="col-md-12" id="course_info">
						<div class="form-body">
							<!-- BEGIN FORM-->
							<form id="modify_form" class="form-horizontal" method="post" action="${basepath }/mgr/activity/modifyactivity.xhtml" >
								<div class="form-group" id="con_name">
									<label class="control-label col-md-3">活动名称<span
										class="required">*</span></label>
									<div class="col-md-6">
										<input type="text" name="name" id="name" value="${activity.name }" data-required="1" class="form-control"/>
									</div>
                                    <div class="col-md-3">
								...
								<div class="form-group" id="con_sponsor">
									...
									<div class="col-md-6">
										<input type="text" name="sponsor" id="sponsor" data-required="1" 
											class="form-control" value="${activity.sponsor }" />
									</div>
									<div class="col-md-3">
								...
								<div class="form-group" id="con_activityStartDate">
									...
									<div class="col-md-6">
                                        <input type="text"  class="form-control"  id="activityStartDate" name="activityStartDate" 
                                         onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',minDate:'%y-%M-%d %H:%m'})" value='<d:formatDate format="yyyy-MM-dd HH:mm" currentTime="${activity.startDate }"/>' class="form-control Wdate"/>
								...
								<div class="form-group" id="con_activityEndDate">
									...
									<div class="col-md-6">
                                        <input type="text" class="form-control"  id="activityEndDate" name="activityEndDate" value='<d:formatDate format="yyyy-MM-dd HH:mm" currentTime="${activity.endDate }"/>'
								...
								<div class="form-group" id="con_lastApplyDate">
									...
									<div class="col-md-6">
                                        <input type="text" id="lastApplyDate" class="form-control"  name="lastApplyDate" value='<d:formatDate format="yyyy-MM-dd HH:mm" currentTime="${activity.lastApplyDate }"/>' 
								...
								<div class="form-group" id="con_activityImage">
									...
									<input type="hidden" name="activityImage" value="${activity.picUrl }" id="activityImage"/>
									<div class="col-md-6">
				                        <div class="tab-content">
				                           <div class="tab-pane active" id="portlet_tab1">
												<input id="file_upload" name="file_upload" class="form-control" type="file" multiple="true">
												<div id="showImage">
												<img src="http://img0.aijiayou.com/${activity.picUrl }-portalCover">
												</div>
								...
								<div class="form-group" id="con_address">
									...
									<div class="col-md-6">
										<input type="radio" name="apply" style="margin-left:0px;" value="1" ${activity.apply eq 1 ? 'checked="checked"' :'' } />是&nbsp;&nbsp;
										<input type="radio" name="apply" style="margin-left:0px;" value="0" ${activity.apply eq 0 ? 'checked="checked"' :'' } />否
									</div>
								</div>
								<div class="form-group" id="con_descript">
									<label class="control-label col-md-3">活动简介</label>
									<div class="col-md-6">
										<textarea rows="2" cols="" name="descript" id="descript"  class="form-control mytextarea" onchange="v_descript();">${activity.desc }</textarea>
									</div>
                                    <div class="col-md-3">
								...
								<div class="form-group" id="con_myEditor">
									...
									<div class="col-md-9">
									<textarea name="content" id="myEditor"  style="border: #f8f8f8;background-color: #f8f8f8;">${activity.content }</textarea>
                                    </div>
                                    <div class="col-md-0"><!-- 
								...
								<div class="form-group" id="con_signinCode">
									...
									<div class="col-md-6">
										<input type="text" name="signinCode" id="signinCode" value="${activity.signinCode }" data-required="1"
											class="form-control" />
									</div>
									<div class="col-md-3">
								...
								<div class="form-group" id="con_findKeys">
									...
									<div class="col-md-6">
										<input type="text" name="findKeys" id="findKeys" value="${activity.findKeys }" data-required="1"
											class="form-control"/>
										<input type="hidden" id="findKey" value="${activity.findKeys }" />
									</div>
									<div class="col-md-3">
								...
								<div class="form-group" id="con_address">
									...
									<div class="col-md-6">
										<input type="radio" name="style" style="margin-left:0px;" value="series" onclick="changeImg('seriesstyle')" id="series"  ${activity.style eq 'series' ? 'checked="checked"' :'' } /><label for="series">&nbsp;系列</label>&nbsp;&nbsp;
										<input type="radio" name="style" style="margin-left:0px;" value="time"  id="time" onclick="changeImg('timestyle')"  ${activity.style eq 'time' ? 'checked="checked"' :'' }/><label for="time">&nbsp;时间轴</label>
										<br/>
								...
								<div class="row">
									<div class="col-md-offset-3 col-md-9">
										<button type="button" onclick="validateAll()" id="subButton" class="btn green">保存修改</button>
...
//			myHide("tip_"+id);
		...
		function backToList(){
			location = "${basepath}/mgr/activity/index.xhtml";
		}
