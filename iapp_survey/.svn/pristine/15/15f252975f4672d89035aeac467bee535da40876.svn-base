		...
		<div class="col-md-12">
			...
			<ul class="page-breadcrumb breadcrumb">
				<%-- <li><i class="icon-home"></i><a href="${basepath }">首页</a><i class="icon-angle-right"></i></li>
				 --%><li><a href="${basepath }/mgr/vote/index.xhtml">${surveyOrvote}管理</a></li>
			</ul>
									...
									<div id="voteContent">
										...
										<div class="form-group " id="vote_score" style="display: none;">
											<div class="form-group" id="con_minScore">
												<label>最低分</label>
												<input type="text" class="form-control" name="minScore" id="minScore" placeholder="1" onchange="v_minscore();">
												<span class="help-block hidden" id="tip_minScore">1-9</span>
											</div>
											<div class="form-group" id="con_maxScore">
												...
												<span class="help-block hidden" id="tip_maxScore">2-10 大于最低分</span>
											</div>
