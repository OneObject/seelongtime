	...
	<body>
        <div class="wrapper-box" id="wrapper-box-1">
            ...
            <section class="wrapper-static margin-top-50" id="wrapper-static">
                <div class="wrapper-text-editor margin-bottom-51" id="wrapper-text-editor">
                    <div class="simple-rich-editor" id="simple-rich-editor" contenteditable="true"></div>
                </div>
            </section>
            <section class="block-fixed-func" id="block-fixed-func">
        ...
        var windowSize = [window.innerWidth, window.innerHeight];
            $(function () {
                ...
                $simpleRichEditor.bind('focus', function () {
