...
public class WxCpInRedisConfigStorage implements WxCpConfigStorage {
	...
	// @Override
	 ...
	 //缓存jsapiTicket的key
	private String getJsapiTicketKey() {
		return String.format("wxcp_jst_%s", this.corpId);
	}
	private String getjsapiTicketExpiresKey(){
		return String.format("wxcp_jst_ttl_%s", this.corpId);
	}
