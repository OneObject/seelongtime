...
<title>抽奖</title>
<link href="${basepath}/static/ixin/css/activity-style.css"
...
<body data-role="page" class="activity-scratch-card-winning">
	<script src="${basepath}/static/ixin/js/jquery.js"
		type="text/javascript"></script>
	<script src="${basepath}/static/ixin/js/wScratchPad.js"
		type="text/javascript"></script>
	<div class="main">
		<!-- 抽奖区域 -->
		<c:if
			...
			<div class="cover" id="card"
				...
				<img
					src="${basepath}/static/ixin/img/activity-scratch-card-bannerbg.png">
				<div id="prize"></div>
	...
	<script type="text/javascript">
			...
			$("#save-btn").bind("click", function() {
				...
				$.ajax({
					type:"post",
					url:"${basepath}/protal/activity/submitreward.xhtml",
