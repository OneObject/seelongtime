		...
		<div class="col-md-12">
			<div class="portlet box green">
				<div class="portlet-title">
					<div class="caption">
						<i class="icon-globe"></i>创建规则
					</div>
				</div>
				<div class="portlet-body form" style="overflow: hidden;">
					<form id="addForm" onsubmit="return validateAdd()" class="form-horizontal" role="form" action="${basepath }/mgr/ixin/power/doadd.xhtml">
						<div class="form-body">
							<div class="form-group" id="con_ruleName">
								<label class="col-md-4 control-label">规则名称<span class="required">*</span></label>
								<div class="col-md-4">
									<input type="text" class="form-control" name="ruleName" id="ruleName" onchange="v_ruleName()">
								</div>
                                <div class="col-md-4">
							...
							<div class="form-group" id="con_keywords">
								...
								<div class="col-md-4">
									<input type="text" class="form-control" name="keywords" id="keywords" onchange="v_keywords()">
								</div>
                                <div class="col-md-4">
								...
								<div class="col-md-4">
									<div class="radio-list" id="judge" >
										<label class="radio-inline">
											<input type="checkbox" name="matchAll" id="matchAll" value="1" checked="checked" >是
										</label>
									</div>
								</div>
                                <div class="col-md-4">
							...
							<%-- <div class="form-group" id="con_responseAll">
								<label class="col-md-4 control-label">回复全部</label>
								<div class="col-md-4">
									<div class="radio-list" id="judge" >
										<label class="radio-inline">
											<input type="checkbox" name="responseAll" id="responseAll" value="1" >是
										</label>
									</div>
								</div>
                                <div class="col-md-4">
                                  <span id="tip_responseAll" for="responseAll" class="help-block hidden" style="">必填</span>
                                </div>
							</div> --%>
                            <div class="form-group" id="con_type">
                                ...
                                <div class="col-md-4">
                                    <div class="radio-list" id="judge" >
                                        <label class="radio-inline">
                                            <input type="radio" name="type" id="type0" value="0" checked="checked" onclick="toggle_type(0);">图文素材
                                        </label> 
                                        <label  class="radio-inline">
                                            <input type="radio" name="type" id="type1" value="1" onclick="toggle_type(1);">文本消息
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="form-group hidden" id="con_content">
                                <label class="control-label col-md-4">文字消息<span class="required">*</span></label>
                                <div class="col-md-4">
                                    <textarea rows="2" cols="" name="content" id="content" class="form-control mytextarea" onchange="v_content();"></textarea>
                                </div>
                                <div class="col-md-4">
                                    <span id="tip_content" for="content" class="help-block " style=""><span id="max_content">300</span>字以内</span>
                                </div>
                            </div>
							<div class="form-group" id="con_matterIds">
