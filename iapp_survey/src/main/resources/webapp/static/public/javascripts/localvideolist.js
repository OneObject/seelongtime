...
function page(i, fieldId) {
	...
	var url = basepath+"/base/admin/localivideo/list.list";
...
function addvideo(){
	window.location.href=basepath+"/base/admin/localivideo/edit.xhtml";
}
function update(id){
	window.location.href=basepath+"/base/admin/localivideo/edit.xhtml?id="+id;
}
...
function deleteEntity(id){
	var tempFn = function (){
		$.ajax({
			type:"POST",
	   	 	url:basepath+"/base/admin/localivideo/delete.json",
	   	 	data:{id:id},
