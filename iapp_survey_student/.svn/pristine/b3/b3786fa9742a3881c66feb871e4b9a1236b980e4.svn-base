...
public class EntityMetaInfo {
	...
	/*
	 * public static enum MODIFYINFO_PROPERTY_NAME { dateCreated, userCreated, dateLastModified, userLastModified;
	 * public boolean equals(String name) { return this.toString().equals(name); } }
	 */
