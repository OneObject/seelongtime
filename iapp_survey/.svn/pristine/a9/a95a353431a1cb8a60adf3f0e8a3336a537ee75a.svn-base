        ...
        <div class="wrap" id="wrap" style="">
            ...
            <article class="post">
                ...
                <div class="post-desc" id="votedate">
                    参与时间：<d:formatDate currentTime="${vo.startTime }" format="yyyy/MM/dd"/>~<d:formatDate currentTime="${vo.endTime }" format="yyyy/MM/dd"/>
                </div>
            </article>
            <div id="inner">
                ...
                <div id="result" class="tpcon" style="margin-bottom:10px;">
                    <dl class="quslist">
                        <dt class="qus-problem">
                            <span class="qus-title">${question.qtitle }  (投票数：${question.voteNum })</span><span class="qus-des">(单选)</span>
                        </dt>
