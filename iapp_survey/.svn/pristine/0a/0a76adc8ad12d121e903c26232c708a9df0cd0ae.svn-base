 ...
 */
@Entity
@Table(name = "ixin_vote_statistics_option")
public class VoteStatisticsOptionEntity  extends BaseModel<String>{
	
	private static final long serialVersionUID = 3400139545167411817L;
