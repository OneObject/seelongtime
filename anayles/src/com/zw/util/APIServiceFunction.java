...
public class APIServiceFunction {
	 ...
	 */
	public static String HttpRetrieve(String triggerURL) throws UnsupportedEncodingException {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		String str = createHashedQueryString(params, System.currentTimeMillis(), "qKRAR9YWvvNkdkJUOOPriu4zWtRMyDXQ");
		HttpRetrieve(Config.api_videos + "?" + str);		//获取到数据
