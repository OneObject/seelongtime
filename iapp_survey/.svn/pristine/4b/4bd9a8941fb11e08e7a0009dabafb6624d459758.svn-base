			...
			<div class="portlet box green">
				<div class="portlet-title">
					<div class="caption">
						...
						<!-- 正式素材ID -->
						<input type="hidden" id="baseId" value="${vo.baseId }">
						<!-- 封面路径 -->
								...
								<div id="appmsgItem1" data-fileid="" data-id="1"
									...
									<h4 class="appmsg_title">
										<a onclick="return false;" href="javascript:void(0);"
											target="_blank" id="single_title">${vo.title }</a>
									</h4>
								...
								<div class="appmsg_edit_item">
									...
									<p class="frm_tips">
										<label for=""	class="frm_checkbox_label js_show_cover_pic selected">
											<input type="checkbox" checked='<c:if test="${vo.coverShowInText ==1 }">checked</c:if>' id="checkbox_info" > 封面图片显示在正文中
										</label>
									</p>
								</div>
...
var editor = UE.getEditor('myEditor',{
    ...
    , toolbars:[["source","bold","italic","underline","|","insertorderedlist","insertunorderedlist","|","insertimage","|",'removeformat','forecolor','backcolor'/*,"insertvideo"*/]]
	,maximumWords:100000
});
...
<script type="text/javascript">
<%--每隔一段时间自动保存素材--%>
window.setInterval(autoSave,1000*10); 
