...
<!-- BEGIN PAGE HEADER-->
              ...
              <div class="col-md-12">
               ...
               <div class="portlet box blue">
                  <div class="portlet-title">
                     <div class="caption"><i class="icon-globe"></i>学习成绩列表</div>
                  </div>
   ...
   <tbody id="tbody">
	          ...
	          <tr>
	             ...
	             <td >学习成绩区域排行</td>
	             <td>
	                  <a href="${basepath }/base/admin/report/appoint/appointindex.xhtml?model=areastudy&from=3">
	                      <span>
	                         		进入
	                     </span>
	                  </a>
	          ...
	          <tr>
	             ...
	             <td >学习成绩人员排行</td>
	             <td>
	                  <a href="${basepath }/base/admin/report/appoint/appointindex.xhtml?model=personstudy&from=3">
	                      <span>
	                         		进入
	                     </span>
	                  </a>
	          ...
	          <tr>
	             ...
	             <td >大区课程学习率</td>
	             <td>
	                  <a href="${basepath}/base/admin/report/appoint/appointindex.xhtml?model=cpthreeamonth&from=3">
	                      <span>
	                         		进入
	                     </span>
	                  </a>
