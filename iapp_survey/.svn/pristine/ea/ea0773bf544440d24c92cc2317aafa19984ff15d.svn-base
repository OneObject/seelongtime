...
/**
 * all the constant variables used in message
 * 
 * @author hujiawei
 * 
 */
public interface IMessage {
	...
	public static final String REPLY_MESSAGE_NEWS = "news";
	public static final String REPLY_MESSAGE_TEXT = "text";// different from MESSAGE_TEXT
