...
public class MsgForm {
    ...
    private String synctxweibo = "0";
    private String synctxnews = "0";
	...
	public String getSynctxweibo() {
		return synctxweibo;
	}

	public void setSynctxweibo(String synctxweibo) {
		this.synctxweibo = synctxweibo;
	}

	public String getSynctxnews() {
		return synctxnews;
	}

	public void setSynctxnews(String synctxnews) {
		this.synctxnews = synctxnews;
	}
