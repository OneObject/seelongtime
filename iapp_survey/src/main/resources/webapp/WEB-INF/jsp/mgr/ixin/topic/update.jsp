		...
		<div class="col-lg-12">
			<div class="portlet box yellow">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-bar-chart-o"></i><span>修改微信墙</span> 
					</div>
				</div>
							...
							<form role="form" id="topicForm" action="${basepath }/mgr/topic/save.xhtml" method="post">
								<div class="form-body">
									<div class="form-group">
										...
										<input type="text" class="form-control" value="${entity.title }" id="topicTitle" name="title" placeholder="">
									...
									<div class="form-group">
										...
										<input type="hidden"  id="topicKeyWord" value="${entity.keywords }">
									...
									<div class="form-group">
										...
										<div>
										<label >
										<input type="radio" name="supportimage" value="1"  ${entity.supportimage eq 1 ?'checked="checked"':'' }   /> 支持&nbsp;&nbsp;&nbsp;
										</label>
										<label >
										<input type="radio" name="supportimage" value="0"  ${entity.supportimage eq 0 ?'checked="checked"':'' }   /> 不支持&nbsp;&nbsp;&nbsp;
										</label>
										</div>
									</div>
										<div class="form-group">
										...
										<div>
										<label >
										<input type="radio" name="isaudit" value="0"  ${entity.isaudit eq 0 ?'checked="checked"':'' }   /> 关闭审核&nbsp;&nbsp;&nbsp;
										</label>
										<label >
										<input type="radio" name="isaudit" value="1"  ${entity.isaudit eq 1 ?'checked="checked"':'' }   /> 开启审核&nbsp;&nbsp;&nbsp;
										</label>
										</div>
									</div>
