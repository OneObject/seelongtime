...
<html>
	...
	<body class="bg-color-gray">
        <div class="wrapper-box" id="wrapper-box-1">
            <header>
            <span class="btn btn-left" id="ring" onclick="tomessage();">
                <span class="bell">
            ...
            <div id="replace-box-1" style="display: none;">
                <section class="wrapper-static margin-top-50 margin-bottom-55">
					...
					<%-- <div><a href="${basepath}/m/study/detail/8a2be106504c3ab801506aa264c51190.xhtml"><img style="display: block;width:100%" src="${basepath}/static/m/ext/enn/img/banner_20151016.jpg" /></a></div> --%>
					...
					<div class="category-line" id="user-category-line-1">
						...
						<c:forEach items="${choosed }" var="item" varStatus="i">
							<c:if test="${i.count lt 9  }"><c:if test="${i.first }"><c:set var="columnidname" value="${item.columnidname }" scope="page"></c:set></c:if>
                        ...
                        <label  class="add-category ${initcolumn ?'':'add-category2' }" onclick="window.location.href='${basepath}/m/ext/enn/column/index.xhtml'">
        ...
        <div class="wrapper-box" id="wrapper-box-2"  style="display: none;">
            <header>
                <span class="btn btn-left" onclick="tomessage();">
                    <span class="bell">
                        <label class="bellicon" style="display: none;"></label>
                    </span>
                </span>
        ...
        <footer>
            <div class="footer-line" id="footer-line">
                <a href="javascript:void(0);" class="active" id="footer-btn-1" data-href="wrapper-box-1">
                    <div>
                        <label></label>
                        <span>首页</span>
                    </div>
        ...
        <script type="text/javascript">
            ...
            function getlist(i){
            	...
            	$.ajax({
					...
					data:{page : i,size :20,model:column,key:querykey},
					cache:false,
