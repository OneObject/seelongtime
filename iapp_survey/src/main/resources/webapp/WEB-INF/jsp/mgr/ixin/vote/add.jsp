		...
		<div class="col-lg-12">
			<div class="portlet box green">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-bar-chart-o"></i><span>创建调研问卷</span> 
					</div>
				</div>
				<div class="portlet-body main_bd box">
					...
					<div class="col-md-12">
						<!-- 创建 start-->
						<div class="form">
							<form role="form" id="voteForm" action="${basepath }/mgr/vote/save.xhtml" method="post">
								<div class="form-body">
									<div class="form-group"  id="con_title">
										<label for="biaoti">标题<span class="required">*</span></label>
										<input type="text" class="form-control" value="" name="title" id="title" placeholder="活动标题" onchange="v_title();">
									...
									<div class="form-group" id="con_voteSummary">
										...
										<textarea rows="6" class="form-control" id="voteSummary" name="summary" placeholder="${surveyOrvote }说明"></textarea>
										<div class="col-md-3">
					...
					<!-- 添加 end -->
					<div class="btngroup">
							<div class="btn btn-block btn-success" onclick="save();">下一步</div>
						</div>
				</div>
			</div>
		</div>
