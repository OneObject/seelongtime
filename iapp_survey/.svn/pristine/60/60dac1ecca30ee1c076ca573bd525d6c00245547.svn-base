	...
	<tbody>
		...
		<c:forEach items="${list }" var="item" varStatus="num">
			<tr>
				...
				<td>
                    <a class="" href="${basepath }/base/admin/authorize/authorize.xhtml?rid=${item.id}&rcategory=2&scategory=2"><span><i class="icon-leaf"></i>组织授权</span></a>&nbsp;
                    <a class="" href="${basepath }/base/admin/authorize/authorize.xhtml?rid=${item.id}&rcategory=2&scategory=1"><span><i class="icon-user-md"></i>人员授权</span></a>
				</td>
			</tr>
		</c:forEach>	
	</tbody>
