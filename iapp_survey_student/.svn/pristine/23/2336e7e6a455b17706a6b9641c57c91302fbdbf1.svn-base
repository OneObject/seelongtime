        ...
        <section class="wrapper-static margin-top-50" id="wrapper-static">
            <div class="rank-list rank-list-2">
                <ul>
                    ...
                    <li>
                        <a href="${basepath }/m/ext/enn/rank/rank.xhtml?model=ctotal">
                            <label></label>
                            <div>产业内指导人财富榜</div>
                        </a>
                    </li>
                    <li>
                        <a href="${basepath }/m/ext/enn/rank/rank.xhtml?model=coachtotal">
                            <label></label>
                            <div>指导人财富总榜</div>
                        </a>
                    </li>
                    <li>
                        <a href="${basepath }/m/ext/enn/rank/rank.xhtml?model=smonthtotal">
                            <label></label>
                            <div>学员经验排行月榜</div>
                        </a>
                    </li>
                    <li>
                        <a href="${basepath }/m/ext/enn/rank/rank.xhtml?model=stotal">
                            <label></label>
                            <div>学员经验排行总榜</div>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="${basepath }/m/ext/enn/rank/rank.xhtml?model=daren">
                            <label></label>
                            <div>达人财富总榜</div>
                        </a>
                    </li>
