 ...
 <!-- BEGIN HEADER -->   
   <div class="header navbar navbar-inverse navbar-fixed-top">
      ...
      <div class="header-inner">
         ...
         <img src="${basepath}/static/public/metronic.bootstrap/assets/img/logo.png" alt="logo" class="img-responsive" />
         </a>
         <!-- END LOGO -->
                  ...
                  <li>
                     <ul class="dropdown-menu-list scroller" style="height: 250px;">
                        <li>  
                           ...
                           <span class="photo"><img src="${basepath}/static/public/metronic.bootstrap/assets/img/avatar2.jpg" alt=""/></span>
                           <span class="subject">
                        ...
                        <li>  
                           <a href="inbox14c8.html?a=view">
                           <span class="photo"><img src="${basepath}/static/public/metronic.bootstrap/assets/img/avatar3.jpg" alt=""/></span>
                           <span class="subject">
                        ...
                        <li>  
                           <a href="inbox14c8.html?a=view">
                           <span class="photo"><img src="${basepath}/static/public/metronic.bootstrap/assets/img/avatar1.jpg" alt=""/></span>
                           <span class="subject">
