...
<script type="text/javascript">
   $(document).ready(function(){
	   ...
	   if(isok){
		   //easyDialog.close();
		   window.location.href=basepath+"/mgr/activity/recordindex.xhtml?id=${activityId}&from=${from}";
		   }
         ...
         <!-- END PAGE HEADER-->
          <div class="row">
          	<div class="col-md-12" style="display: block;overflow: hidden;margin-bottom: 20px;">
          		<span class="btn btn-success table_add " style="float: left;" onclick="javascript:location.href='${basepath}/modelfile/人员导入模板.xls'" >
          ...
          <div class="row">
          <form id="importForm" action="${basepath }/mgr/activity/batchuser.xhtml" enctype="multipart/form-data" method="post">
